...
const promisfy = require('./cursor-promisfy');
...
class DataStore extends nedb {
    ...
    find(query, projection) {
        return promisfy(super.find(query, projection));
    }
    ...
    findOne(query, projection) {
        return promisfy(super.findOne(query, projection));
    }
     ...
     */
    count(query) {
        return promisfy(super.count(query));
    }
